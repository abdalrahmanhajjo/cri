import pathlib
p = pathlib.Path("src/i18n/translations.js")
s = p.read_text(encoding="utf-8")
old = """      exploreDining: 'Explore dining options',
...
if old not in s:
    raise SystemExit("old EN block not found")
p.write_text(s.replace(old, new, 1), encoding="utf-8")
print("patched EN discover/dining/hotel blocks")
