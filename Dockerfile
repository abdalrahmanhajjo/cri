...
# Optional UI toggles (see client/.env.example). Omit or set to 1/true to enable; 0/false to slim the public UI.
ARG VITE_FEATURE_WEATHER=
ENV VITE_FEATURE_WEATHER=$VITE_FEATURE_WEATHER
ARG VITE_FEATURE_HOME_COMMUNITY_STRIP=
ENV VITE_FEATURE_HOME_COMMUNITY_STRIP=$VITE_FEATURE_HOME_COMMUNITY_STRIP
ARG VITE_FEATURE_COMMUNITY_NAV=
ENV VITE_FEATURE_COMMUNITY_NAV=$VITE_FEATURE_COMMUNITY_NAV
RUN npm run build
